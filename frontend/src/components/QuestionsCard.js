...
const QuestionsCard = ({ question }) => {
  ...
  return (
    <Link to={`/questions/${question._id}`} className="card mb-3 text-decoration-none" style={{ width: '100%', margin: '10px', backgroundColor: '#ffffff', borderRadius: '15px', boxShadow: '0 4px 8px rgba(0, 0, 0, 0.1)', transition: 'transform 0.2s', minHeight: '200px', flex: '1 0 auto' }} onClick={(e) => e.stopPropagation()}>
