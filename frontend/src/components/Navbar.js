...
const Navbar = () => {
  ...
  const avatarUrl = user?.avatar ? `http://localhost:5000${user.avatar}` : 'http://localhost:5000/uploads/user.png';
    ...
    <nav className="navbar navbar-expand-lg" style={{ marginLeft: '0', borderBottom: '1px solid rgb(205, 215, 234)', paddingTop: '5px', paddingBottom: '5px' }}>
      <div className="container-sm">
        <Link className="navbar-brand" to="/" style={{ marginLeft: '0' }}>
          <img
            src={`${process.env.PUBLIC_URL}/site-logo.png`} // Replace with your logo filename
            alt="Student Forum Academic Logo"
            style={{ height: '80px', width: '250px', marginLeft: '-50px', marginBottom: '0px' }} // Adjusted size and margin
          />
        </Link>
        <button
          ...
          <ul className="navbar-nav mx-auto mb-2 mb-lg-0" style={{ marginLeft: 'auto', marginRight: 'auto' }}>
            <li className="nav-item">
              <Link
                ...
                onMouseEnter={(e) => (e.target.style.color = '#e04b2a')} // Different hover color
            ...
            <li className="nav-item">
              <Link
                ...
                style={{
                  transition: 'color 0.3s',
                  color: '#ff5733',
                  textDecoration: location.pathname === '/ask' ? 'underline' : 'none',
                }}
                onMouseEnter={(e) => (e.target.style.color = '#e04b2a')} // Different hover color
            ...
            {user ? (
              ...
              <li className="nav-item">
                <Link
                  ...
                  style={{
                    backgroundColor: '#ff5733', // Filled box like Login page
                    color: '#ffffff',
